...
/**
 * CreatePlaylist es el componible encargado de mostrar la interfaz para crear una nueva lista.
 *
 * @param mainViewModel [MainViewModel] contiene los estados y llamadas necesarias.
 * @param onCreate devolución de llamada para la creación de una nueva lista.
...
fun CreatePlaylist (
    ...
    Column(
        modifier = Modifier.padding(horizontal = if (isVertical) 50.dp else 120.dp,vertical=if (isVertical) 80.dp else 10.dp).fillMaxHeight(),
        ...
        Text(
            text = stringResource(R.string.nombre_nueva_playlist),
